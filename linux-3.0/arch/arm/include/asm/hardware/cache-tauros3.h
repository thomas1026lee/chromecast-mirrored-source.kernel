...
#define PHYS_SL2C_IO_BASE           0xA0000000
...
#define TAUROS3_PREFETCH_CTRL		0xF60

#define TAUROS3_PREFETCH_MASK		0x1F

#define TAUROS3_AWCACHE	 		(0 << 23)
#define TAUROS3_FORCE_NO_WA		(1 << 23)
#define TAUROS3_FORCE_WA		(2 << 23)
#define TAUROS3_WA_MASK			(3 << 23)
...
#ifndef __ASSEMBLY__
extern int __init tauros3_init(void __iomem * base, __u32 aux_val,
			       __u32 aux_mask);
#endif
#endif
