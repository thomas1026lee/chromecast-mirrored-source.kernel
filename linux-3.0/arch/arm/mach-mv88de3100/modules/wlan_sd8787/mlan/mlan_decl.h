...
#define MLAN_RELEASE_VERSION		"337"
...
MLAN_API int mlan_hist_data_get(char *pBuf, unsigned int *pNumSamples);
MLAN_API int mlan_hist_data_clear();
MLAN_API void* mlan_memcpy(void *pDest, void *pSrc, unsigned int count);
