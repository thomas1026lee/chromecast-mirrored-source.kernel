...
mlan_debug_info_hist info_hist;
...
module_param(cfg80211_wext, int, 0444);
...
module_param(wq_sched_prio, int, 0444);
module_param(wq_sched_policy, int, 0444);
