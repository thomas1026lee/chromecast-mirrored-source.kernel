...
#endif
#endif //CONFIG_MV88DE3100_FASTLOGO
...
#if (BERLIN_CHIP_VERSION >= BERLIN_BG2)
#if (BERLIN_CHIP_VERSION >= BERLIN_BG2_A0)
	free_irq(IRQ_SM_CEC, pHandle);
#else
	free_irq(IRQ_SM_GPIO0, pHandle);
#endif
#endif

	/* unregister VPP interrupt */
	free_irq(IRQ_DHUBINTRAVIO0, pHandle);
	/* unregister VIP interrupt */
	free_irq(IRQ_DHUBINTRAVIO2, pHandle);
	/* unregister VDEC interrupt */
	free_irq(IRQ_DHUBINTRVPRO, pHandle);
	/* unregister audio out interrupt */
	free_irq(IRQ_DHUBINTRAVIO1, pHandle);
	/* unregister ZSP interrupt */
	free_irq(IRQ_ZSPINT, pHandle);
