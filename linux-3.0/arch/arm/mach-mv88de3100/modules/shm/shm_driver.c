...
static uint shm_size = CONFIG_MV88DE3100_SHMMEM_SIZE;
module_param(shm_size, uint, 0644);

static uint shm_base_cache = CONFIG_MV88DE3100_SHMMEM_START;
module_param(shm_base_cache, uint, 0644);

static uint shm_size_cache = CONFIG_MV88DE3100_SHMMEM_CACHE_SIZE;	//0x4000000; //64M should be enough??
module_param(shm_size_cache, uint, 0644);

static uint shm_size_noncache =
    CONFIG_MV88DE3100_SHMMEM_SIZE - CONFIG_MV88DE3100_SHMMEM_CACHE_SIZE;
static uint shm_base_noncache =
    (CONFIG_MV88DE3100_SHMMEM_START + CONFIG_MV88DE3100_SHMMEM_CACHE_SIZE);
