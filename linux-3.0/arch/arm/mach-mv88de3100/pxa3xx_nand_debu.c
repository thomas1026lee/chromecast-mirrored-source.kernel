...
{ "2GiB 8-bit",    0xd5ec, 0x7694, 128, 8192,  8,  8, 48, 2048, &timing[5], 1 },
};
...
#ifdef CONFIG_MV88DE3100_NAND_RANDOMIZER
...
#endif /* CONFIG_MV88DE3100_NAND_RANDOMIZER */
...
static inline int is_read_datbuf_blank(int ecc, int pagesize,
...
static int pxa3xx_nand_scan(struct mtd_info *mtd, int type_plane)
{
	...
	if ((f->chip_id == 0xd7ec && f->ext_id == 0x7a94) ||
			...
			(f->chip_id == 0xd5ec && f->ext_id == 0x7694))
